...
public:
	...
	*/
	...
	private:
	const FVector2D CardinalDirections[4] = {FVector2D(0, 1), FVector2D(-1, 0), FVector2D(1, 0), FVector2D(0,-1)};
	const FVector2D DiagonalDirections[4] = {FVector2D(-1, 1), FVector2D(1, 1), FVector2D(-1, -1), FVector2D(1, -1)};

	bool IsValidXDirection(int32 Index, int X) const;
};
